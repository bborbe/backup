...
export NAME=backup
export BINS="backup_cleanup backup_keep backup_latest backup_list backup_old backup_resume backup_status_server"
export INSTALLS="github.com/bborbe/backup/bin/backup_cleanup github.com/bborbe/backup/bin/backup_keep github.com/bborbe/backup/bin/backup_latest github.com/bborbe/backup/bin/backup_list github.com/bborbe/backup/bin/backup_old github.com/bborbe/backup/bin/backup_resume github.com/bborbe/backup/bin/backup_status_server"
