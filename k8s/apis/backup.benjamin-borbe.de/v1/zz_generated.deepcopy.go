...
func (in BackupDirectories) DeepCopyInto(out *BackupDirectories) {
	{
		in := &in
		*out = make(BackupDirectories, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupDirectories.
func (in BackupDirectories) DeepCopy() BackupDirectories {
	if in == nil {
		return nil
	}
	out := new(BackupDirectories)
	in.DeepCopyInto(out)
	return *out
}
