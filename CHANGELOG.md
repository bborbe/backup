...
- chore: update Go to 1.27.1 and github.com/bborbe/collection to v1.20.26, github.com/bborbe/cron to v1.8.32, github.com/bborbe/errors to v1.6.1, github.com/bborbe/http to v1.26.26, github.com/bborbe/k8s to v1.14.19, github.com/bborbe/log to v1.6.25, github.com/bborbe/run to v1.10.2, github.com/bborbe/sentry to v1.10.1, github.com/bborbe/service to v1.10.13, github.com/bborbe/time to v1.27.14, github.com/bborbe/validation to v1.5.0, github.com/getsentry/sentry-go to v0.49.0, github.com/onsi/gomega to v1.43.0, k8s.io/apiextensions-apiserver to v0.37.0, k8s.io/apimachinery to v0.37.0, k8s.io/client-go to v0.37.0
